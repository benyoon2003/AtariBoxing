...
def train(batch_size, gamma, epsilon, epsilon_limit, decay_factor, LR, model_path, episodes):   
...
def main():
    ...
    parser.add_argument("--model_path", type=str, default="models/DQN/dqn.pth", help="Model path")
